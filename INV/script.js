...
function limpiarYCentrar() {
    ...
    mensaje.innerHTML = '<h3 class="centrar" id="parpadeo">  ERGUIIII JAJA sabia que a mi MI AMOR, te ganaste algo que te mandare el 14 💜, Te quiero baby &#128150;</h3>';
    contenedor.appendChild(mensaje);
    document.body.appendChild(contenedor);
    var imagen = document.createElement('div');
    imagen.innerHTML = '<img src="img/croco2.gif" alt="" class="giff" style="width: 200px; height: 200px;">';
